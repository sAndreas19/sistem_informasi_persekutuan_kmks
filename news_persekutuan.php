		...
		<div class="container">
          ...
          ?>
						...
						<div class="news_post">
							...
							<div class="news_body">
								<div class="news_title"><a href="news_detail.php?id=<?php echo base64_encode($data['id']); ?>"><?php echo $data['judul']; ?></a></div>
								<div class="news_info">
									<ul>
							...
							<a href="news_detail.php?id=<?php echo base64_encode($data['id']); ?>">SELENGKAPNYA</a>
						</div>
							</div>
						</div>
