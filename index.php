							...
							<div class="row">
								<div class="col">
									<div class="home_content_inner">
										...
										<div class="button home_button">
											<a href="news_persekutuan.php">_belum jadi</a>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-4 box_col">
					<div class="box box_emergency">
						...
						<div class="box_emergency_text">Ps. Jayanta Bangun</div>
						 ...
						 <a href="https://api.whatsapp.com/send?phone=6285277948885&amp;text=Hallo%20 Saudara/i terkasih dalam nama Tuhan Yesus Nama : ,%20Saya%20:%20...">
                        <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-whatsapp fa-stack-1x fa-inverse"></i>
                   </span>Wa : +62 813-7572-2746</a> 
                   <br>
                   	 <a href="tel:085277948885">
                        <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-phone fa-stack-1x fa-inverse"></i>
                   </span>Call : +62 813-7572-2746</a> 
