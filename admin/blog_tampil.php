	...
	<div class="card-body">
		<h3>DAFTAR NEWS</h3>
                  <div class="table-responsive">
					...
					$sql = mysqli_query($konek, "SELECT * FROM pengumuman LIMIT ".$limit_start.",".$limit);
					...
					?>
						<tr>
							...
							<td> <a href="blog_edit.php?id=<?php echo base64_encode($data['id']); ?>">EDIT</a></td>
							<td> <a href="blog_hapus.php?id=<?php echo $data['id']; ?> ">DELETE</a></td>
						</tr>
					<?php
			...
			<ul class="pagination">
				...
				$sql2 = mysqli_query($konek, "SELECT COUNT(*) AS jumlah FROM pengumuman");
